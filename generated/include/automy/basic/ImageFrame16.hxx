...
class AUTOMY_BASIC_EXPORT ImageFrame16 : public ::automy::basic::ImageFrame {
public:
...
void ImageFrame16::accept_generic(T& _visitor) const {
	_visitor.template type_begin<ImageFrame16>(5);
	...
	_visitor.template type_end<ImageFrame16>(5);
}
