...
const vnx::Hash64 ImageFrame16::VNX_TYPE_HASH(0x6f04dc915f2801b0ull);
const vnx::Hash64 ImageFrame16::VNX_CODE_HASH(0xff41abd58b6c31a2ull);

vnx::Hash64 ImageFrame16::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string ImageFrame16::get_type_name() const {
	return "automy.basic.ImageFrame16";
}

const vnx::TypeCode* ImageFrame16::get_type_code() const {
...
void ImageFrame16::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = automy::basic::vnx_native_type_code_ImageFrame16;
...
void ImageFrame16::write(std::ostream& _out) const {
	_out << "{\"__type\": \"automy.basic.ImageFrame16\"";
...
vnx::Object ImageFrame16::to_object() const {
	vnx::Object _object;
	_object["__type"] = "automy.basic.ImageFrame16";
	_object["time"] = time;
	_object["frame"] = frame;
...
vnx::Variant ImageFrame16::get_field(const std::string& _name) const {
	if(_name == "time") {
...
void ImageFrame16::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "time") {
		_value.to(time);
	} else if(_name == "frame") {
		_value.to(frame);
...
const vnx::TypeCode* ImageFrame16::static_get_type_code() {
...
std::shared_ptr<vnx::TypeCode> ImageFrame16::static_create_type_code() {
	auto type_code = std::make_shared<vnx::TypeCode>();
	type_code->name = "automy.basic.ImageFrame16";
	type_code->type_hash = vnx::Hash64(0x6f04dc915f2801b0ull);
	type_code->code_hash = vnx::Hash64(0xff41abd58b6c31a2ull);
	type_code->is_native = true;
	type_code->is_class = true;
	type_code->native_size = sizeof(::automy::basic::ImageFrame16);
...
std::shared_ptr<vnx::Value> ImageFrame16::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
...
void write(TypeOutput& out, const ::automy::basic::ImageFrame16& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = automy::basic::vnx_native_type_code_ImageFrame16;
		out.write_type_code(type_code);
		vnx::write_class_header<::automy::basic::ImageFrame16>(out);
	}
