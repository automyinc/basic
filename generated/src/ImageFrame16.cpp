...
const vnx::Hash64 ImageFrame16::VNX_TYPE_HASH(0xbd55ea917aeba8b6ull);
const vnx::Hash64 ImageFrame16::VNX_CODE_HASH(0x3c2a9df8c6c99b74ull);
...
const vnx::TypeCode* ImageFrame16::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xbd55ea917aeba8b6ull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> ImageFrame16::create_type_code() {
	...
	type_code->name = "basic.ImageFrame16";
	type_code->type_hash = vnx::Hash64(0xbd55ea917aeba8b6ull);
	type_code->code_hash = vnx::Hash64(0x3c2a9df8c6c99b74ull);
...
void write(TypeOutput& out, const ::basic::ImageFrame16& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::basic::ImageFrame16>(out);
		vnx::write_class_header<::basic::ImageFrame16>(out);
	}
