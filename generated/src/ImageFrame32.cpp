...
std::string ImageFrame32::get_type_name() const {
...
vnx::Variant ImageFrame32::get_field(const std::string& _name) const {
	if(_name == "time") {
...
void ImageFrame32::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "time") {
		_value.to(time);
	} else if(_name == "frame") {
		_value.to(frame);
...
std::shared_ptr<vnx::TypeCode> ImageFrame32::static_create_type_code() {
	...
	type_code->native_size = sizeof(::automy::basic::ImageFrame32);
...
std::shared_ptr<vnx::Value> ImageFrame32::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
