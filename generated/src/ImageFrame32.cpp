...
const vnx::Hash64 ImageFrame32::VNX_TYPE_HASH(0x6f57da313cc5149full);
const vnx::Hash64 ImageFrame32::VNX_CODE_HASH(0x599cda246b398dbcull);
...
const vnx::TypeCode* ImageFrame32::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0x6f57da313cc5149full));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> ImageFrame32::create_type_code() {
	...
	type_code->name = "basic.ImageFrame32";
	type_code->type_hash = vnx::Hash64(0x6f57da313cc5149full);
	type_code->code_hash = vnx::Hash64(0x599cda246b398dbcull);
	type_code->is_class = true;
	type_code->parents.resize(1);
	type_code->parents[0] = ::basic::ImageFrame::get_type_code();
...
void write(TypeOutput& out, const ::basic::ImageFrame32& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::basic::ImageFrame32>(out);
		vnx::write_class_header<::basic::ImageFrame32>(out);
	}
