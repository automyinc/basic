...
const vnx::TypeCode* ImageFrame32::get_type_code() {
...
std::shared_ptr<vnx::TypeCode> ImageFrame32::create_type_code() {
	...
	type_code->parents[0] = ::automy::basic::ImageFrame::get_type_code();
...
void write(TypeOutput& out, const ::automy::basic::ImageFrame32& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::automy::basic::ImageFrame32>(out);
