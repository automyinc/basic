...
const vnx::Hash64 ImageFrame8::VNX_TYPE_HASH(0xd5cc519f12ca26ddull);
const vnx::Hash64 ImageFrame8::VNX_CODE_HASH(0x2c0818cd91b1704ull);
...
const vnx::TypeCode* ImageFrame8::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xd5cc519f12ca26ddull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> ImageFrame8::create_type_code() {
	...
	type_code->name = "basic.ImageFrame8";
	type_code->type_hash = vnx::Hash64(0xd5cc519f12ca26ddull);
	type_code->code_hash = vnx::Hash64(0x2c0818cd91b1704ull);
...
void write(TypeOutput& out, const ::basic::ImageFrame8& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::basic::ImageFrame8>(out);
		vnx::write_class_header<::basic::ImageFrame8>(out);
	}
