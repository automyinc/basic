...
const vnx::Hash64 ImageFrameF16::VNX_TYPE_HASH(0xcb4cc3aae78794cdull);
const vnx::Hash64 ImageFrameF16::VNX_CODE_HASH(0xe6d435ab1c27b7bbull);

vnx::Hash64 ImageFrameF16::get_type_hash() const {
	return VNX_TYPE_HASH;
}

const char* ImageFrameF16::get_type_name() const {
	return "basic.ImageFrameF16";
}
...
const vnx::TypeCode* ImageFrameF16::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xcb4cc3aae78794cdull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> ImageFrameF16::create_type_code() {
	std::shared_ptr<vnx::TypeCode> type_code = std::make_shared<vnx::TypeCode>(true);
	type_code->name = "basic.ImageFrameF16";
	type_code->type_hash = vnx::Hash64(0xcb4cc3aae78794cdull);
	type_code->code_hash = vnx::Hash64(0xe6d435ab1c27b7bbull);
...
void write(TypeOutput& out, const ::basic::ImageFrameF16& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::basic::ImageFrameF16>(out);
		vnx::write_class_header<::basic::ImageFrameF16>(out);
	}
