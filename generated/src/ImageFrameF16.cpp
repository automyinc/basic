...
const vnx::Hash64 ImageFrameF16::VNX_TYPE_HASH(0x44ca674fb06da90cull);
const vnx::Hash64 ImageFrameF16::VNX_CODE_HASH(0xb90276290bd202d3ull);

vnx::Hash64 ImageFrameF16::get_type_hash() const {
	return VNX_TYPE_HASH;
}

std::string ImageFrameF16::get_type_name() const {
	return "automy.basic.ImageFrameF16";
}

const vnx::TypeCode* ImageFrameF16::get_type_code() const {
	return automy::basic::vnx_native_type_code_ImageFrameF16;
}

std::shared_ptr<ImageFrameF16> ImageFrameF16::create() {
	return std::make_shared<ImageFrameF16>();
}

std::shared_ptr<vnx::Value> ImageFrameF16::clone() const {
	return std::make_shared<ImageFrameF16>(*this);
}

void ImageFrameF16::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void ImageFrameF16::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void ImageFrameF16::accept(vnx::Visitor& _visitor) const {
	const vnx::TypeCode* _type_code = automy::basic::vnx_native_type_code_ImageFrameF16;
...
void ImageFrameF16::write(std::ostream& _out) const {
	_out << "{\"__type\": \"automy.basic.ImageFrameF16\"";
...
void ImageFrameF16::from_object(const vnx::Object& _object) {
...
vnx::Variant ImageFrameF16::get_field(const std::string& _name) const {
	if(_name == "time") {
...
void ImageFrameF16::set_field(const std::string& _name, const vnx::Variant& _value) {
	if(_name == "time") {
		_value.to(time);
	} else if(_name == "frame") {
		_value.to(frame);
...
/// \private
std::ostream& operator<<(std::ostream& _out, const ImageFrameF16& _value) {
	_value.write(_out);
	return _out;
}

/// \private
std::istream& operator>>(std::istream& _in, ImageFrameF16& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* ImageFrameF16::static_get_type_code() {
...
std::shared_ptr<vnx::Value> ImageFrameF16::vnx_call_switch(std::shared_ptr<const vnx::Value> _method) {
...
void write(TypeOutput& out, const ::automy::basic::ImageFrameF16& value, const TypeCode* type_code, const uint16_t* code) {
	...
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = automy::basic::vnx_native_type_code_ImageFrameF16;
