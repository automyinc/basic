...
const vnx::Hash64 ImageFrameF32::VNX_TYPE_HASH(0x194ef30aa1a928e4ull);
const vnx::Hash64 ImageFrameF32::VNX_CODE_HASH(0x4558b8f53e6914e3ull);
...
const vnx::TypeCode* ImageFrameF32::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0x194ef30aa1a928e4ull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> ImageFrameF32::create_type_code() {
	...
	type_code->name = "basic.ImageFrameF32";
	type_code->type_hash = vnx::Hash64(0x194ef30aa1a928e4ull);
	type_code->code_hash = vnx::Hash64(0x4558b8f53e6914e3ull);
...
void write(TypeOutput& out, const ::basic::ImageFrameF32& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::basic::ImageFrameF32>(out);
		vnx::write_class_header<::basic::ImageFrameF32>(out);
	}
