...
const vnx::Hash64 ImageFrameF64::VNX_TYPE_HASH(0x38e362976fbfd30ull);
const vnx::Hash64 ImageFrameF64::VNX_CODE_HASH(0xe4d2c95ca0062085ull);

vnx::Hash64 ImageFrameF64::get_type_hash() const {
	return VNX_TYPE_HASH;
}

const char* ImageFrameF64::get_type_name() const {
	return "basic.ImageFrameF64";
}

std::shared_ptr<ImageFrameF64> ImageFrameF64::create() {
	return std::make_shared<ImageFrameF64>();
}

std::shared_ptr<vnx::Value> ImageFrameF64::clone() const {
	return std::make_shared<ImageFrameF64>(*this);
}

void ImageFrameF64::read(vnx::TypeInput& _in, const vnx::TypeCode* _type_code, const uint16_t* _code) {
	vnx::read(_in, *this, _type_code, _code);
}

void ImageFrameF64::write(vnx::TypeOutput& _out, const vnx::TypeCode* _type_code, const uint16_t* _code) const {
	vnx::write(_out, *this, _type_code, _code);
}

void ImageFrameF64::accept(vnx::Visitor& _visitor) const {
...
void ImageFrameF64::read(std::istream& _in) {
...
void ImageFrameF64::from_object(const vnx::Object& _object) {
...
/// \private
std::istream& operator>>(std::istream& _in, ImageFrameF64& _value) {
	_value.read(_in);
	return _in;
}

const vnx::TypeCode* ImageFrameF64::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0x38e362976fbfd30ull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> ImageFrameF64::create_type_code() {
	std::shared_ptr<vnx::TypeCode> type_code = std::make_shared<vnx::TypeCode>(true);
	type_code->name = "basic.ImageFrameF64";
	type_code->type_hash = vnx::Hash64(0x38e362976fbfd30ull);
	type_code->code_hash = vnx::Hash64(0xe4d2c95ca0062085ull);
	type_code->is_class = true;
	type_code->parents.resize(1);
	type_code->parents[0] = ::basic::ImageFrame::get_type_code();
	type_code->create_value = []() -> std::shared_ptr<vnx::Value> { return std::make_shared<ImageFrameF64>(); };
...
void write(TypeOutput& out, const ::basic::ImageFrameF64& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::basic::ImageFrameF64>(out);
		vnx::write_class_header<::basic::ImageFrameF64>(out);
	}
