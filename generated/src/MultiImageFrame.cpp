...
const vnx::Hash64 MultiImageFrame::VNX_TYPE_HASH(0xa219a448403692c6ull);
const vnx::Hash64 MultiImageFrame::VNX_CODE_HASH(0x748c075689cdcfa7ull);
...
const vnx::TypeCode* MultiImageFrame::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0xa219a448403692c6ull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> MultiImageFrame::create_type_code() {
	std::shared_ptr<vnx::TypeCode> type_code = std::make_shared<vnx::TypeCode>(true);
	type_code->name = "basic.MultiImageFrame";
	type_code->type_hash = vnx::Hash64(0xa219a448403692c6ull);
	type_code->code_hash = vnx::Hash64(0x748c075689cdcfa7ull);
...
void write(TypeOutput& out, const ::basic::MultiImageFrame& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::basic::MultiImageFrame>(out);
		vnx::write_class_header<::basic::MultiImageFrame>(out);
	}
