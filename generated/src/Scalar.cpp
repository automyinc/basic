...
const vnx::Hash64 Scalar::VNX_TYPE_HASH(0x5bdfa582de6d88dbull);
const vnx::Hash64 Scalar::VNX_CODE_HASH(0xc9354b66d07a08abull);
...
const vnx::TypeCode* Scalar::get_type_code() {
	const vnx::TypeCode* type_code = vnx::get_type_code(vnx::Hash64(0x5bdfa582de6d88dbull));
	if(!type_code) {
...
std::shared_ptr<vnx::TypeCode> Scalar::create_type_code() {
	...
	type_code->name = "basic.Scalar";
	type_code->type_hash = vnx::Hash64(0x5bdfa582de6d88dbull);
	type_code->code_hash = vnx::Hash64(0xc9354b66d07a08abull);
...
void write(TypeOutput& out, const ::basic::Scalar& value, const TypeCode* type_code, const uint16_t* code) {
	if(!type_code || (code && code[0] == CODE_ANY)) {
		type_code = vnx::write_type_code<::basic::Scalar>(out);
		vnx::write_class_header<::basic::Scalar>(out);
	}
