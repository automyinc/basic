...
const vnx::Hash64 TransformPublisherBase::VNX_CODE_HASH(0x65782a33b4b2775eull);
...
std::string TransformPublisherBase::get_type_name() const {
...
void TransformPublisherBase::accept(vnx::Visitor& _visitor) const {
	...
	_visitor.type_field(_type_code->fields[2], 2); vnx::accept(_visitor, config);
...
void write(TypeOutput& out, const ::automy::basic::TransformPublisherBase& value, const TypeCode* type_code, const uint16_t* code) {
	...
	vnx::write(out, value.config, type_code, type_code->fields[2].code.data());
