...
std::string TransformPublisher_set_transform_return::get_type_name() const {
...
vnx::Variant TransformPublisher_set_transform_return::get_field(const std::string& _name) const {
	return vnx::Variant();
}

void TransformPublisher_set_transform_return::set_field(const std::string& _name, const vnx::Variant& _value) {
...
std::shared_ptr<vnx::TypeCode> TransformPublisher_set_transform_return::static_create_type_code() {
	...
	type_code->native_size = sizeof(::automy::basic::TransformPublisher_set_transform_return);
